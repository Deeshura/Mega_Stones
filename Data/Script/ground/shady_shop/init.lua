...
function shady_shop.Exposition()
  ...
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_001']))
  GROUND:EntTurn(pult,Dir8.Up)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_002']))
  ...
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_004']))
  ...
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_007']))
  ...
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_008']))
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_009']))
  ...
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_010']))
  ...
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_012']))

  UI:SetSpeakerEmotion("Inspired")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_013']))

  UI:SetSpeakerEmotion("Inspired")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_014']))
  ...
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_015']), {absweat})

  UI:SetSpeakerEmotion("Worried")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_016']))

  UI:SetSpeakerEmotion("Joyous")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_017']))

  UI:SetSpeakerEmotion("Inspired")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_018']))
  ...
  UI:SetSpeakerEmotion("Inspired")
  UI:SetSpeakerReverse(true)
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Exposition_019']))
